...
// d) -8.921= Math.trunc(-8.921)=-9,Math.floor(-8.921)=-9
...
//The difference between Math.trunc() and Math.floor() is Math.trunc() rounding to the nearest integer but Math.floor() is lowering to the nearest down integer by ignoring the decimal
